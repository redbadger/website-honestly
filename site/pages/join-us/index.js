    ...
    children: [
      {
        ...
        props: {
          children:
            'We are consultants - what does that mean? On top of our chosen discipline, we are great communicators, able to drop the jargon in favour of helping everyone understand a problem... and a solution, whether they are technical or not.',
        },
      },
      {
        type: 'Paragraph',
        props: {
          children:
            "Our consultants have conversations, workshop solutions and present back to multiple members of the teams. They collaborate and work hard to optimise their team's performance, not just their apps.",
        },
      },
      {
        type: 'Paragraph',
