    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <p className={styles.highlightParagraph}>
          ...
          big thing in web development? React? Angular 2? CycleJS? WebSockets? HTTP2?
          Instead of looking into the future for a bit, let’s take a few steps back.
          The web has developed into an incredible thing since it began – from static, funky looking
          pages into a net of apps connecting millions of people in realtime – Facebook.
        </p>
        ...
        <p className={styles.paragraph}>
          ...
          web applications to catch up with these.
          There are a few glaring differences between web and native apps that heavily benefit the
          latter:
        </p>
        ...
        <p className={styles.paragraph}>
          ...
          application, and how much we’ve learnt to expect from mobile experience.
          While checking things out on our phones, we’re quite often in places with horrible mobile
          internet,
          abroad on roaming, or we’re juggling morning coffee, opening the office door and chatting
          on WhatsApp all at the same time.
          So at the end of the day, it’s not just a matter of comfort for smart phone users – it’s a
          necessity due to phones’ flexibility.
        </p>
        ...
        <p className={styles.paragraph}>
          ...
          These guys can create a layer between the browser and server that lives on the client and
          can be persistent.
          That gives us huge power – and also great responsibility.
          We can push notifications, store our whole websites and databases locally for the user to
          access them at any point in time,
        ...
        <p className={styles.paragraph}>
          ...
          offline.
          As much as every point in the list above is important, using our apps whenever and
          wherever means a huge difference in the way we perceive the web.
        </p>
        <p className={styles.paragraph}>
          As I mentioned above, Service Workers create a layer between a rendered page and server
          that can handle a lot of things for us and that we can manipulate using javascript.
          When a user goes to our website for the first time, it creates a service worker, checks if
          we have this page cached, and then goes onto the server to fetch it.
          On its way back, the data gets saved in cache and from this time on, our website can be
          rendered from cache.
