      ...
      <div className={styles.content}>
        ...
        <div className={styles.content__wrapper}>
          ...
          <p className={styles.content__paragraph}>
            Sky are continuously focused on providing customers the services they want and need.
            It’s part of a simple, two-pronged attack: Sky seeks to improve what it has, and provide
            what it doesn’t have already. As part of this, Sky found that there was a higher demand
            for online self-help services as customers’ own digital skills grow.
          </p>
          <p className={styles.content__paragraph}>
            As such, Sky was determined to enhance the use of their online self-help tools for
            in-home diagnostics, allowing issues to be resolved quicker. Taking this, Sky set out to
            enable customers to troubleshoot problems for themselves, particularly during times of
            widespread issues. This, in order to help prevent the helpline being overwhelmed with
          ...
          <p className={styles.content__paragraph}>
            With a clear message of achieving customer empowerment, our onsite team at Red Badger
            got to work. The team focused on improving the online help and support experience by
            enabling customers to find content, resolve issues, navigate available services, and set
            up their Sky equipment correctly.
          </p>
          <p className={styles.content__paragraph}>
          ...
          <ContactBox />
          <p className={styles.content__paragraph}>
            Through the use of clustered articles, customers are now able to find what they need
            when they need it. Additionally, the help section was bolstered to handle spikes in
            activity; saving customers from having to reach for the phone. So, when the football
            match starts glitching, the Sky team can make sure that the solution is up on the site,
            or if one is still being found, can put a pop up on the page to reassure customers are
            that they are working to find the solution needed.
          </p>
          <p className={styles.content__paragraph}>
            <img
              src={articleImage}
          ...
          <p className={styles.content__paragraph}>
            ...
            Focused initially on in-home advanced diagnostics, the first customer facing delivery
            was made in less than three weeks, leaving room to implement further customer feedback.
          </p>
          <p className={styles.content__paragraph}>
