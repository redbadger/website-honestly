      ...
      <div className={styles.content}>
        <div className={styles.content__wrapper}>
          ...
          <p className={styles.content__paragraph}>
            ...
            new platform runs. This design allows for a continuous delivery model, meaning that tiny
            incremental changes are constantly tested and released to production multiple times a
            day (instead of a few times a year), helping to bid farewell to the age of big bang
            releases.
          </p>
          <div className={styles.content__float}>
            <Quote
          ...
          <p className={styles.content__paragraph}>
            ...
            design from concept through to delivery, in just eight months and for under £1.3
            milllion.
          </p>
          <h2 className={styles.content__title}>
          ...
          <p className={styles.content__paragraph}>
            ...
            colour prominent throughout, the new site is fast, slick and easy to navigate - and
            truly responsive, delivering optimal layouts across every view port.
          </p>
          <p className={styles.content__paragraph}>
          ...
          <p className={styles.content__paragraph}>
            Further to this, fortnumandmason.com won a BIMA Award for ‘Best Web Design & Build’ and
            an eCommerce Award for ‘Best eCommerce New Design or Re-Design (Under 1 Year)’ in 2015.
            The project was also nominated for the UK Digital Experience Awards in the Retail sector
            award and as ‘Best Use of Website to Build Your Brand’. It was also nominated at the
            Retail Week Tech and Ecommerce Awards in the ‘Best Customer Experience’ category.
          </p>
