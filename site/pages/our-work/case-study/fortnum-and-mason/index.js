...
class CaseStudyFortnumAndMason extends React.Component<{}> {
  static addYTScript() {
  ...
  componentDidMount() {
    if (!window.YT) {
      CaseStudyFortnumAndMason.addYTScript();
    }
  ...
  addPlayerInitCallback() {
    ...
    this.player = new window.YT.Player('fm-case-study-video', {
      videoId: 'eBE3J9XZO20',
      events: {
          ...
          <div className={styles.content}>
            <div className={styles.content__wrapper}>
              ...
              <p className={styles.content__paragraph}>
                ...
                layout, amazing customer service and the incredibly high quality of products,
                springs to mind. This unrivalled reputation, held over 300 years, has always been
                led by the store experience. But with more and more shoppers heading online to make
                purchases from over 130 different countries, Fortnum’s realised their digital
                experience didn’t match the service delivered by the physical stores, and something
              ...
              <p className={styles.content__paragraph}>
                ...
                underlying technology was nearing the end of its life. The out-dated technology
                meant that high levels of customers were dropping out at certain stages in the
                buying process. For example, the presentation of delivery options was confusing and
                if one element of a customer’s order was unavailable, it could result in the entire
                order not going out for delivery.
              </p>
              <p className={styles.content__paragraph}>
              ...
              <p className={styles.content__paragraph}>
                We also designed, implemented and managed the Cloud-based architecture upon which
                the new platform runs. This design allows for a continuous delivery model, meaning
                that tiny incremental changes are constantly tested and released to production
                multiple times a day (instead of a few times a year), helping to bid farewell to the
                age of big bang releases.
              </p>
              <div className={styles.content__float}>
                <Quote
              ...
              <p className={styles.content__paragraph}>
                The process and technology had the customer at the heart of the project but the key
                to the success was engaging Fortnum’s customers to help drive the direction of the
                design and development of the site by allowing them to provide feedback directly to
                the team. Throughout the project, our design team ran guerrilla testing in the
                flagship store in Piccadilly to get customer feedback on the look and feel of the
                site. The in-store historian was also brought into the project to ensure the new
                design was as aligned to the brand’s heritage as possible.
              </p>
              <p className={styles.content__paragraph}>
                Once launched, the beta site ran in parallel to the old site to avoid disruption and
                a number of Fortnum’s customers were gradually switched over to the new site over a
                two-month period. New site visitors were able to provide feedback to enable further
                customer-centric amends and builds.
              </p>
              <p className={styles.content__paragraph}>
                These changes meant that when the full go-live launch took place the site already
                had features and processes in place that made sense to the user, not just the
                business. This approach also meant that overall the project has achieved a complete
                re-platform and design from concept through to delivery, in just eight months and
                for under £1.3 milllion.
              </p>
              <h2 className={styles.content__title}>
              ...
              <p className={styles.content__paragraph}>
                The new Badger-created site was one of the only fully responsive retail sites that
                was live at the time, which ensures that the customer experience is equally
                superlative no matter what device is used. The site is also built to be scalable and
                flexible enough to support the company’s future ambitions and peaks of online
                traffic, such as Christmas.
              </p>
              <p className={styles.content__paragraph}>
              ...
              <p className={styles.content__paragraph}>
                The drop-out rate at the delivery options stage was previously 18.8% and has now
                been reduced to 12.9% (based figures from 17–25th February 2014 vs 2015.)
              </p>
              ...
              <p className={styles.content__paragraph}>
                With the site now being much easier to navigate there has been an increase in sales
                of specific items, for example a 78% increase in grocery sales.
              </p>
              <p className={styles.content__paragraph}>
                Further to this, fortnumandmason.com won a BIMA Award for ‘Best Web Design & Build’
                and an eCommerce Award for ‘Best eCommerce New Design or Re-Design (Under 1 Year)’
                in 2015. The project was also nominated for the UK Digital Experience Awards in the
