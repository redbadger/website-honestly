      ...
      <div className={styles.content}>
        ...
        <div className={styles.content__wrapper}>
          ...
          <p className={styles.content__paragraph}>
            ...
            available for free. The next generation of ft.com was already underway, and now they
            needed a partner who could help envisage it and bring it to life.
          </p>
          ...
          <p className={styles.content__paragraph}>
            <ul className={styles.content__list}>
              ...
              <li className={styles.content__list__element}>
                Support an organisational shift towards taking an user-centred design (UCD) to
                product development
              </li>
              <li className={styles.content__list__element}>
          ...
          <ContactBox />
          <p className={styles.content__paragraph}>
            In the initial phase of our engagement we redesigned and deployed a new home page in
            just seven weeks. This involved integrating React and GraphQL into the FT’s already
            cutting edge tech stack. Demonstrating not only an improved approach to delivery but
            adding value through introducing new technology.
          </p>
          ...
          <p className={styles.content__paragraph}>
            ...
            processes and systems to new colleagues, creating the perfect environment to reassess
            the effectiveness of each stage of their workflow. We learned how the Financial Times
            operated in the first few weeks of the project. This put us in a position later in the
            project to recommended some changes to the process in the internal design and
            development team.
          </p>
          ...
          <p className={styles.content__paragraph}>
            ...
            this resulted in untraceable productivity. This made predicting delivery times and
            making sound investment decisions difficult. Soon after our arrival we were helping the
            Financial Times to build a legacy of implementing methodologies out in the open, with
            work on kanban boards representing their own processes.
          </p>
          <p className={styles.content__paragraph}>
            We worked with each team one at a time and through an osmosis like process each team
            adopted a more open and collaborative way of working together with UX and Design. Now
            the Financial Times have core metrics measured against each of the backlogs and using
            Little’s Law we can predict completion time, throughput, lead time and cycle time.
          </p>
          ...
          <p className={styles.content__paragraph}>
            On going contact beyond our engagement is a given, to offer any level of support
            required during the maturation of the businesses UCD approach to product development.
          </p>
        </div>
      </div>
      ...
      <div className={styles.content}>
        <div className={styles.content__wrapper}>
          ...
          <p className={styles.content__paragraph}>
            ...
            FT senior management in a controlled and considered way ensures that the gradual
            cultural shift in working practices and approach to Lean UX and Agile Design is not
            short lived. On the contrary, through careful coaching and support we have created an
            environment where teams now make iterative changes to how UX and Design is considered
            and integrated with other teams, including technology and customer research across the
            business.
          </p>
          <p className={styles.content__paragraph}>
            ...
            processes, integrating Lean UX and Agile Design into all areas of product delivery
            across the organisation.
          </p>
          <p className={styles.content__paragraph}>
            It remains one of the fastest news sites in the world, loading in 1.5 seconds on desktop
            and 2.1 on mobile, reader engagement has increased by 30%, with visitors reading more
            and returning more frequently. It has also won Website of the Year at the Press Awards
            and Best Use of Technology at Digiday Publishing Awards.
          </p>
        </div>
      </div>
