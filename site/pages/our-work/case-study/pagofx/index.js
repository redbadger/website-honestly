    ...
    <Body>
      <Section>
        ...
        <P>
          ...
          and learnt that customers who’d used traditional banks to make international money
          transfers were frustrated with hidden fees, long delivery times, and poor visibility of
          payments.
        </P>
        <P>
          This valuable information allowed us to better understand the problems we needed to solve,
          as well as who’s been struggling with these problems and how.
        </P>
        <P>
          Red Badger put the product in the hands of real users early on, through a comprehensive
          user onboarding initiative. We worked closely with PagoFX’s business, legal and tech teams
          to create a journey that met their requirements as well as the needs of users. The result?
          We crafted a product that gave users a strong sense of security and that’s simple and easy
          to use.
        </P>
        <P>
          We took the same user-centric approach to defining the payments journey, too. And we did
          everything we could to make the payment process refreshingly transparent.
        </P>
      ...
      <Section>
        ...
        <P>
          ...
          was given the autonomy to make product and technology choices and to experiment safely in
          isolation.
        </P>
        <P>
          For dramatically increased speed to market, the initial minimum desirable product was
          built using a number of third party services for some of the key functionality, with the
          longer-term strategy to migrate onto Santander platforms where appropriate.
        </P>
        <P>
          The first step towards an end-to-end product was to produce a pilot proving the key
          features we knew we needed: customer registration; the “Know Your Customer” verification
          process; acquiring funds from the customer; exchanging currency on the FX market; and
          sending money to the recipient.
        </P>
        <P>
      ...
      <Section>
        ...
        <SectionBody>
          <P>
            Santander established a separate legal entity for PagoFX and submitted an application
            for a payments license to the UK and EU regulators. Red Badger gave expert support from
            a technology perspective, covering cloud architecture, the processing of sensitive
            information, and general information security controls.
          </P>
          <P>
            The pilot’s success meant the next goals were a full launch in the UK, followed by the
          ...
          <UL>
            ...
            <li>
              A staff-facing customer and payment operations portal – enabling operators to monitor
              customer onboarding and payments processing so they could support customers and
              monitor for any financial crime
            </li>
            <li>
              An accounting ledger system to keep track of the precise movements of funds during
          ...
          <P>
            ...
            process was designed to be collaborative, allowing key stakeholders and team members to
            understand and empathise with the user.
          </P>
          <P>
            We created a clear roadmap to incorporate customer desires and feedback, to continue to
            improve the experience and grow the customer base.
          </P>
          <Triptych />
        </SectionBody>
      </Section>
      <Section>
        ...
        <SectionBody>
          ...
          <P>
            In under 18 months, Red Badger helped PagoFX go from prototype to live product. The live
            product we created is now being rolled out globally.
          </P>
          <P>
            We’re proud of the work we’ve done to help create a foundation which PagoFX can
            confidently build upon in the future. Above all, we’re excited that so many customers
            will be able to make use of this trusted, secure and innovative product to send money
            abroad quickly and safely.
          </P>
        </SectionBody>
      </Section>
    </Body>
