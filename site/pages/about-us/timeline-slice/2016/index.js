...
const Six = () => {
  ...
  const text =
    '2016 saw our fastest growth yet as we reached number 44 on the Tech Track 100 list and featured in Sunday Times. We took on an array of new clients (but we can’t talk about the best one) brought in some incredible new members of staff and welcomed Milo, the office dog.';
  const fact =
