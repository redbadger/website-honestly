...
class Timeframe extends Component<TimeframeProps, TimeframeState> {
  ...
  setLayoutOnResize = () => {
    window.addEventListener('resize', () => {
      ...
      const determineTimeframeOpen = this.determineTimeframeOpen.bind(this);
      const previousWindowSize = this.state.currentWindowSize;
      const currentWindowSize = window.innerWidth;
      this.setState({
        mobileView: mobileViewOnResize(),
        open: determineTimeframeOpen(previousWindowSize, currentWindowSize),
        currentWindowSize,
      });
    });
  };

  props: TimeframeProps;
  ...
  determineTimeframeOpen = (previousWindowSize: number, currentWindowSize: number) => {
